...
const MOCK_CTA_CONTENT = {
  ...
  description:
    "Зв'яжіться з нами, щоб обговорити вашу ідею та отримати безкоштовну консультацію вже сьогодні.",
...
const CTASection: React.FC<CTASectionProps> = ({
  ...
  return (
    <section
      id="cta"
      className={`py-20 md:py-28 ${accentColor} shadow-2xl transition-colors duration-500`}
    >
      <CTAContent
